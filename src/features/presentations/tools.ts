...
export const toolDefs: ToolDef[] = [
  ...
  { name: "create_proof_template", description: `Create proof template. POST /proof-templates.
...
⚠️ IMPORTANT: Truvera's proof request structure may differ from standard Indy/W3C conventions (attribute naming, request format). ALWAYS check the Truvera API spec for exact field names and formats: https://swagger-api.truvera.io/openapi.yaml`, inputSchema: components.schemas.CreateProofTemplateRequest },
  ...
  { name: "create_proof_request", description: `Create proof request from template. POST /proof-templates/{templateId}/request.
